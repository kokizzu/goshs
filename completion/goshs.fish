...
complete -c goshs -l template           -d 'Enable ?tpl payload templating in served files'
complete -c goshs -l tpl-var            -d 'Template variable KEY=VALUE (repeatable), e.g. LPORT=4444'
